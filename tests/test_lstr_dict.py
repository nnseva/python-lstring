...
class TestLStrHashMapping2(unittest.TestCase):
    ...
    def test_concat_keys(self):
        ab = self.d + lstring.lstr("c")
        abc = lstring.lstr("abc")
        d = {ab: "concat"}
